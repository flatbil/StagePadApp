    ...
    var body: some View {
        NavigationStack {
            ...
            VStack(alignment: .leading, spacing: 20) {
                ...
                // Song colors — moved to its own screen (see SongColorsView):
                // with a real setlist this row list gets long, and it's a
                // set-once-per-song styling concern, not something glanced at
                // on every visit to Settings the way connection info is.
                NavigationLink {
                    SongColorsView()
                } label: {
                    HStack {
